...
struct EXP ParticleAux : public coord::PosVelCar {
...
typedef EXP ParticleArray<coord::PosVelCar>  ParticleArrayCar;
typedef EXP ParticleArray<coord::PosVelCyl>  ParticleArrayCyl;
typedef EXP ParticleArray<coord::PosVelSph>  ParticleArraySph;
typedef EXP ParticleArray<ParticleAux> ParticleArrayAux;
...
struct EXP Converter<coord::PosVelT<SrcCoordT>, coord::PosVelT<DestCoordT> > {
...
template<typename SrcCoordT, typename DestCoordT>
struct EXP Converter<coord::PosVelT<SrcCoordT>, coord::PosT<DestCoordT> > {
...
template<typename SrcCoordT, typename DestCoordT>
struct EXP Converter<coord::PosT<SrcCoordT>, coord::PosT<DestCoordT> > {
...
struct EXP Converter<ParticleAux, coord::PosT<DestCoordT> > {
...
template<typename DestCoordT>
struct EXP Converter<ParticleAux, coord::PosVelT<DestCoordT> > {
