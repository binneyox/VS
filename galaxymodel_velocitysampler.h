...
class EXP SphericalIsotropicModelLocal;  // forward declaration
class EXP JeansAxi;                      // another forward declaration
...
*/
EXP particles::ParticleArrayCar assignVelocityEdd(
...
*/
EXP particles::ParticleArrayCar assignVelocityJeansSph(
    const particles::ParticleArray<coord::PosCyl>& pointCoords,
    const potential::BasePotential& pot,
...
*/
EXP particles::ParticleArrayCar assignVelocityJeansAxi(
    const particles::ParticleArray<coord::PosCyl>& pointCoords,
    const potential::BasePotential& pot,
...
*/
EXP particles::ParticleArrayCar assignVelocity(
    const particles::ParticleArray<coord::PosCyl>& pointCoords,
