...
class EXP DensitySphericalHarmonic: public BaseDensity {
public:
...
*/
class EXP PowerLawMultipole: public BasePotentialCyl {
public:
...
class EXP Multipole: public BasePotentialCyl{
public:
...
*/
EXP void computeDensityCoefsSph(const BaseDensity& dens,
    const math::SphHarmIndices& ind,
    const std::vector<double>& gridRadii,
...
*/
EXP void computeDensityCoefsSph(
    const particles::ParticleArray<coord::PosCyl> &particles,
    const math::SphHarmIndices &ind,
    const std::vector<double> &gridRadii,
    std::vector< std::vector<double> > &coefs,
...
/** Compute spherical-harmonic expansion coefficients for a multi-component density.
    ...
    \throws std::invalid_argument if gridRadii are not correct or any error occurs in the computation.
*/
EXP void computeDensityCoefsSph(const math::IFunctionNdim& dens,
    const math::SphHarmIndices& ind,
    const std::vector<double>& gridRadii,
...
*/
EXP void computePotentialCoefsSph(const BaseDensity &dens, 
    const math::SphHarmIndices &ind,
    const std::vector<double> &gridRadii,
    std::vector< std::vector<double> > &Phi,
...
EXP void computePotentialCoefsSph(const BasePotential& pot,
    const math::SphHarmIndices& ind,
    const std::vector<double> &gridRadii,
    std::vector< std::vector<double> > &Phi,
    std::vector< std::vector<double> > &dPhi);
