...
EXP double v_circ(const math::IFunction& potential, double r);
...
/** Compute the radius of a circular orbit with the given energy
    in a spherically-symmetric potential represented by a 1d function */
EXP double R_circ(const math::IFunction& potential, double E);
...
*/
EXP double innerSlope(const math::IFunction& potential, double* Phi0=NULL, double* coef=NULL);
...
*/
EXP void findPlanarOrbitExtent(const BasePotential& potential, double E, double L,
    double& R1, double& R2);
...
*/
class EXP Interpolator: public math::IFunction {
public:
    ...
    */
    ...
    //returns Om/kappa and nu/Om
    void epicycle_ratios(const double, double*) const;
...
*/
class EXP Interpolator2d: public Interpolator {
public:
...
*/
class EXP PhaseVolume: public math::IFunction {
public:
