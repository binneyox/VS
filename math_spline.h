...
class EXP BaseInterpolator1d: public IFunction {
public:
...
class EXP LinearInterpolator: public BaseInterpolator1d {
public:
    ...
    */
    ...
    /* interpolate from f to x rather from x to f
     * */
    double evalReverse(const double f) const;
};
...
*/
class EXP CubicSpline: public BaseInterpolator1d, public IFunctionIntegral {
public:
...
*/
class EXP QuinticSpline: public BaseInterpolator1d {
public:
...
*/
class EXP LogLogSpline: public BaseInterpolator1d {
public:
    /// empty constructor
    LogLogSpline() {}
...
*/
template<int N>
class EXP BsplineInterpolator1d: public IFunctionNdimAdd {
public:
...
template<int N>
class EXP BsplineWrapper: public IFunction {
public:
...
class EXP BaseInterpolator2d: public IFunctionNdim {
public:
    BaseInterpolator2d() {}
...
class EXP LinearInterpolator2d: public BaseInterpolator2d {
public:
...
class EXP CubicSpline2d: public BaseInterpolator2d {
public:
...
class EXP QuinticSpline2d: public BaseInterpolator2d {
public:
...
class EXP LinearInterpolator3d: public IFunctionNdim {
public:
...
class EXP CubicSpline3d: public IFunctionNdim {
public:
    CubicSpline3d() {}
...
*/
template<int N>
class EXP BsplineInterpolator3d: public IFunctionNdim {
public:
...
*/
template<int N>
EXP std::vector<double> createBsplineInterpolator3dArray(
...
*/
template<int N>
EXP std::vector<double> splineLogDensity(
    const std::vector<double> &grid,
    const std::vector<double> &xvalues,
    const std::vector<double> &weights=std::vector<double>(),
...
*/
EXP std::vector<double> createAlmostUniformGrid(unsigned int nnodes, 
...
*/
EXP std::vector<double> createSymmetricGrid(unsigned int nnodes, double xmin, double xmax=NAN);
