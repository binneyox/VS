...
void PoiClosedOrbit::set_parameters(Potential *Phi, const Actions J) {
  ...
  double *tbR=new double[Nt];
  double *tbz=new double[Nt];
  double *tbr=new double[Nt];
  double *tbvr=new double[Nt];
  double *tbpth=new double[Nt];
  double *tbdrdth=new double[Nt];
  double *tbir=new double[Nt];
  double *tbth=new double[Nt];
  
//  double time[Nt], tbR[Nt], tbz[Nt], tbr[Nt], tbvr[Nt], tbpth[Nt], tbdrdth[Nt],tbir[Nt],tbth[Nt]; // tables from orbit integration
