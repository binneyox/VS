...
EXP math::LogLogSpline createJeansSphModel(
...
EXP JeansAxi::JeansAxi(const potential::BaseDensity &dens, const potential::BasePotential &pot,
...
EXP void JeansAxi::moments(const coord::PosCyl& point, coord::VelCyl &vel, coord::Vel2Cyl &vel2) const
{
