...
EXP PyObject* createCubicSpline(const std::vector<double>& x, const std::vector<double>& y);
...
EXP PyObject* setUnits(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* resetUnits(PyObject* /*self*/, PyObject* /*args*/)
{
...
EXP void convertParticlesStep1(PyObject* particles_obj,
...
EXP particles::ParticleArray<ParticleT> convertParticlesStep2(
...
template<typename ParticleT>
EXP particles::ParticleArray<ParticleT> convertParticles(PyObject* particles_obj)
{
...
*/
template<int DIM>
EXP PyObject* allocateOutput(npy_intp numPoints, double* buffer[1]=NULL, int C=0)
{
    if(numPoints<0)
        return NULL;
...
EXP PyObject* allocateOutput(npy_intp numPoints, double* buffer[2]=NULL, int C=0)
{
...
EXP PyObject* allocateOutput(npy_intp numPoints, double* buffer[3]=NULL, int C=0)
{
    PyObject *elem1 = allocateOutput<DIM1>(numPoints, buffer, C);
    PyObject *elem2 = allocateOutput<DIM2>(numPoints, buffer? &buffer[1] : NULL, C);
...
EXP void Density_dealloc(DensityObject* self)
{
    if(self->dens)
...
EXP potential::PtrDensity getDensity(PyObject* dens_obj, coord::SymmetryType sym=coord::ST_TRIAXIAL)
{
    if(dens_obj == NULL)
...
EXP potential::PtrPotential getPotential(PyObject* pot_obj);

/// create a Python Density object and initialize it with an existing instance of C++ density class
EXP PyObject* createDensityObject(const potential::PtrDensity& dens)
{
...
EXP potential::PtrDensity Density_initFromCumulMass(PyObject* cumulMass)
{
...
EXP potential::PtrDensity Density_initFromDict(PyObject* namedArgs)
{
...
EXP potential::PtrDensity Density_initFromTuple(PyObject* tuple)
{
...
EXP int Density_init(DensityObject* self, PyObject* args, PyObject* namedArgs)
{
    try{
...
EXP class FncDensityDensity: public BatchFunction {
...
EXP PyObject* Density_surfaceDensity(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* Density_totalMass(PyObject* self)
{
    try{
...
EXP PyObject* Density_export(PyObject* self, PyObject* args)
{
...
EXP PyObject* Density_sample(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* Density_name(PyObject* self)
{
...
EXP PyObject* Density_elem(PyObject* self, Py_ssize_t index)
{
    try{
        const potential::CompositeDensity& dens =
            dynamic_cast<const potential::CompositeDensity&>(*((DensityObject*)self)->dens);
...
EXP Py_ssize_t Density_len(PyObject* self)
{
    try{
...
EXP void Potential_dealloc(PotentialObject* self)
{
    if(self->pot)
...
EXP PyObject* createPotentialObject(const potential::PtrPotential& pot)
{
...
EXP potential::PtrPotential Potential_initFromDict(PyObject* args)
{
...
EXP potential::PtrPotential Potential_initFromTuple(PyObject* tuple)
{
...
EXP int Potential_init(PotentialObject* self, PyObject* args, PyObject* namedArgs)
{
    try{
...
EXP bool Potential_isCorrect(PyObject* self)
{
    if(self==NULL) {
...
EXP class FncPotentialPotential: public BatchFunction {
...
EXP PyObject* Potential_potential(PyObject* self, PyObject* args)
{
...
template<bool DERIV>
EXP class FncPotentialForce: public BatchFunction {
    const potential::BasePotential& pot;
...
EXP PyObject* Potential_force(PyObject* self, PyObject* args) {
    if(!Potential_isCorrect(self))
        return NULL;
    return FncPotentialForce<false>(args, *((PotentialObject*)self)->pot).run(/*chunk*/256);
}

EXP PyObject* Potential_forceDeriv(PyObject* self, PyObject* args) {
    if(!Potential_isCorrect(self))
        return NULL;
...
EXP class FncPotentialRcirc: public BatchFunction {
    const potential::BasePotential& pot;
    double* outputBuffer;
public:
...
EXP PyObject* Potential_Rcirc(PyObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!Potential_isCorrect(self))
        return NULL;
...
EXP class FncPotentialTcirc: public BatchFunction {
    const potential::BasePotential& pot;
    double* outputBuffer;
public:
...
EXP PyObject* Potential_Tcirc(PyObject* self, PyObject* arg)
{
...
EXP class FncPotentialRmax: public BatchFunction {
    const potential::BasePotential& pot;
    double* outputBuffer;
public:
...
EXP PyObject* Potential_Rmax(PyObject* self, PyObject* arg) {
    if(!Potential_isCorrect(self))
        return NULL;
...
template<bool INPUTXV>
EXP class FncPotentialRperiapo: public BatchFunction {
    const potential::BasePotential& pot;
    double* outputBuffer;
public:
...
EXP PyObject* Potential_Rperiapo(PyObject* self, PyObject* args)
{
...
EXP PyObject* Potential_name(PyObject* self)
{
    if(!Potential_isCorrect(self))
        return NULL;
...
EXP PyObject* Potential_elem(PyObject* self, Py_ssize_t index)
{
    if(!Potential_isCorrect(self))
        return NULL;
    try{
...
EXP Py_ssize_t Potential_len(PyObject* self)
{
    if(!Potential_isCorrect(self))
        return -1;
    try{
...
EXP void ActionFinder_dealloc(ActionFinderObject* self)
{
...
EXP PyObject* createActionFinderObject(actions::PtrActionFinder af)
{
...
EXP actions::PtrActionFinder createActionFinder(const potential::PtrPotential& pot, bool interpolate)
{
    assert(pot);
...
EXP int ActionFinder_init(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP void formatActions(const actions::Actions& act, double* outputActions)
{
...
EXP void formatActionsAnglesFreqs(const actions::ActionAngles& actang, const actions::Frequencies& freq,
...
EXP class FncActions: public BatchFunction {
...
EXP PyObject* ActionFinder_value(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* actions(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP void ActionMapper_dealloc(ActionMapperObject* self)
{
...
EXP int ActionMapper_init(ActionMapperObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP class FncActionMapper: public BatchFunction {
...
EXP PyObject* ActionMapper_value(ActionMapperObject* self, PyObject* args, PyObject* namedArgs)
{
    if(self->am==NULL) {
...
EXP static PyMemberDef ActionMapper_members[] = {
...
EXP void DistributionFunction_dealloc(DistributionFunctionObject* self)
{
...
EXP class DistributionFunctionWrapper: public df::BaseDistributionFunction{
    OmpDisabler ompDisabler;
    PyObject* fnc;
public:
...
EXP df::PtrDistributionFunction getDistributionFunction(PyObject* df_obj)
{
    if(df_obj == NULL)
...
EXP PyObject* createDistributionFunctionObject(df::PtrDistributionFunction df)
{
...
template<int N>
EXP df::PtrDistributionFunction DistributionFunction_initInterpolated(PyObject* namedArgs)
{
...
EXP df::PtrDistributionFunction DistributionFunction_initFromDict(PyObject* namedArgs)
{
...
EXP df::PtrDistributionFunction DistributionFunction_initFromTuple(PyObject* tuple)
{
...
EXP int DistributionFunction_init(DistributionFunctionObject* self, PyObject* args, PyObject* namedArgs)
{
    try{
...
EXP class FncDistributionFunction: public BatchFunction {
...
EXP PyObject* DistributionFunction_value(DistributionFunctionObject* self, PyObject* args, PyObject* namedArgs)
{
    if(self->df==NULL) {
...
EXP PyObject* DistributionFunction_totalMass(PyObject* self)
{
...
EXP PyObject* DistributionFunction_elem(PyObject* self, Py_ssize_t index)
{
    if(((DistributionFunctionObject*)self)->df==NULL) {
        PyErr_SetString(PyExc_RuntimeError, "DistributionFunction object is not properly initialized");
        return NULL;
...
EXP Py_ssize_t DistributionFunction_len(PyObject* self)
{
...
EXP void GalaxyModel_dealloc(GalaxyModelObject* self)
{
...
EXP bool GalaxyModel_isCorrect(GalaxyModelObject* self)
{
    if(self==NULL) {
...
EXP int GalaxyModel_init(GalaxyModelObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* GalaxyModel_sample_posvel(GalaxyModelObject* self, PyObject* args)
{
...
EXP class FncGalaxyModelMoments: public BatchFunction {
...
EXP PyObject* GalaxyModel_moments(GalaxyModelObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!GalaxyModel_isCorrect(self))
        return NULL;
...
EXP class FncGalaxyModelProjectedMoments: public BatchFunction {
    const galaxymodel::GalaxyModel model; // potential + df + action finder
    const bool separate;                  // whether to consider each DF component separately
    const unsigned int numComponents;     // df.numValues() if separate, otherwise 1
...
EXP PyObject* GalaxyModel_projectedMoments(GalaxyModelObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!GalaxyModel_isCorrect(self))
        return NULL;
...
EXP class FncGalaxyModelProjectedDF: public BatchFunction {
    const galaxymodel::GalaxyModel model; // potential + df + action finder
...
EXP PyObject* GalaxyModel_projectedDF(GalaxyModelObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!GalaxyModel_isCorrect(self))
        return NULL;
...
EXP class FncGalaxyModelVDF: public BatchFunction {
...
EXP PyObject* GalaxyModel_vdf(GalaxyModelObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!GalaxyModel_isCorrect(self))
        return NULL;
...
EXP void Component_dealloc(ComponentObject* self)
{
    if(self->comp)
...
EXP int Component_init(ComponentObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!onlyNamedArgs(args, namedArgs))
        return -1;
...
EXP PyObject* Component_name(PyObject* self)
{
    return Py_BuildValue("s", ((ComponentObject*)self)->name);
}

EXP PyObject* Component_getPotential(ComponentObject* self)
{
...
EXP PyObject* Component_getDensity(ComponentObject* self)
{
...
EXP void SelfConsistentModel_dealloc(SelfConsistentModelObject* self)
{
...
EXP int SelfConsistentModel_init(SelfConsistentModelObject* self, PyObject* args, PyObject* namedArgs)
{
    Py_XDECREF(self->components);
    Py_XDECREF(self->pot);
    Py_XDECREF(self->af);
...
EXP PyObject* SelfConsistentModel_iterate(SelfConsistentModelObject* self)
{
...
EXP void Target_dealloc(TargetObject* self)
{
    if(self->target)
...
EXP int Target_init(TargetObject* self, PyObject* args, PyObject* namedArgs)
{
    if(!onlyNamedArgs(args, namedArgs))
        return -1;
...
EXP PyObject* Target_value(TargetObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* Target_name(TargetObject* self)
{
    return Py_BuildValue("s", self->target->name());
}

EXP PyObject* Target_elem(TargetObject* self, Py_ssize_t index)
{
    try{
...
EXP Py_ssize_t Target_len(TargetObject* self)
{
...
EXP PyObject* ghMoments(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
    if(!onlyNamedArgs(args, namedArgs))
       return NULL;
...
EXP PyObject* orbit(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
    if(!onlyNamedArgs(args, namedArgs))
        return NULL;
...
EXP PyObject* readSnapshot(PyObject* /*self*/, PyObject* arg)
{
...
EXP PyObject* writeSnapshot(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
*/
EXP bool stackVectors(PyObject* obj, const std::vector<int> nRow, std::vector<double>& out)
{
    out.clear();
    if(obj == NULL)
        return true;
...
EXP class StackedMatrix: public math::IMatrix<double> {
...
EXP PyObject* solveOpt(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
    static const char* keywords[] =
...
EXP void CubicSpline_dealloc(PyObject* self)
{
...
EXP int CubicSpline_init(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* CubicSpline_value(PyObject* self, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* splineApprox(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* splineLogDensity(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP class FncWrapper: public math::IFunctionNdim {
...
EXP bool parseLowerUpperBounds(PyObject* lower_obj, PyObject* upper_obj,
...
EXP PyObject* integrateNdim(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP PyObject* sampleNdim(PyObject* /*self*/, PyObject* args, PyObject* namedArgs)
{
...
EXP static PyMethodDef module_methods[] = {
...
EXP void* forget_about_type(void* x) { return x; }
...
#if PY_MAJOR_VERSION < 3
// Python 2.6-2.7
typedef struct EXP PyModuleDef {
    int m_base;
    const char* m_name;
    const char* m_doc;
    Py_ssize_t m_size;
...
EXP static PyObject* PyInit_agama(void);
EXP PyMODINIT_FUNC initagama(void) { PyInit_agama(); }
EXP static PyObject*
#else
// Python 3
EXP PyMODINIT_FUNC
#endif
EXP PyInit_agama(void)
{
