...
*/
EXP ActionAngles actionAnglesIsochrone(
    const double isochroneMass, const double isochroneRadius,
    const coord::PosVelCyl& point,
...
*/
EXP coord::PosVelCyl mapIsochrone(
    const double isochroneMass, const double isochroneRadius,
...
class EXP ToyMapIsochrone: public BaseToyMap<coord::SphMod>{
public:
