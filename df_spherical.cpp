...
EXP void createSphericalIsotropicDF(
...
EXP math::LogLogSpline fitSphericalIsotropicDF(
...
EXP QuasiSphericalCOM::QuasiSphericalCOM(
...
EXP double QuasiSphericalCOM::value(double E, double L, double Lz) const
{
