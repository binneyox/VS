...
class EXP BaseTargetDensity: public BaseTarget {
public:
...
*/
template<int N>
class EXP TargetDensityClassic: public BaseTargetDensity {
...
*/
class EXP TargetDensitySphHarm: public BaseTargetDensity {
...
*/
template<int N>
class EXP TargetDensityCylindrical: public BaseTargetDensity {
