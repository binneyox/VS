...
EXP Actions2d actionsIsochrone2d(const actions::Isochrone,const double q, const coord::PosVelCar& point);
EXP ActionAngles2d actionAnglesIsochrone2d(const actions::Isochrone,const double q, const coord::PosVelCar& point);
...
EXP actions2d::Actions2d getJs(const potential::BasePotential& pot,
			       ...
			       actions::Isochrone& Is, double& Rsh, double& qR, double& qz, double& Jcl,
			       std::vector<double>& Sn, std::vector<std::pair<int,int> >& n);
EXP double checkH(potential::PtrPotential pot, actions::Isochrone Is, const double q, int N, actions2d::Actions2d& J,
	      std::vector<double>& Sn, std::vector<std::pair<int,int> >& n);
}