...
class EXP OdeSolverDOP853: public BaseOdeSolver {
public:
...
*/
template<int NDIM>
class EXP Ode2SolverGL3: public BaseOde2Solver {
public:
...
template<int NDIM>
class EXP Ode2SolverGL4: public BaseOde2Solver {
public:
