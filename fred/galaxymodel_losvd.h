...
*/
template<int N>
class EXP TargetLOSVD: public BaseTarget {
...
*/
template<int N>
class EXP TargetKinemShell: public BaseTarget {
...
public:
    ...
    virtual void computeDFProjection(const GalaxyModel& model, StorageNumT* output, const units::InternalUnits& intUnits) const; //sKpc
