...
*/
class EXP DensityAzimuthalHarmonic: public BaseDensity {
public:
...
*/
class EXP CylSpline: public BasePotentialCyl
{
public:
...
*/
EXP void computeDensityCoefsCyl(const BaseDensity &dens,
...
*/
EXP void computePotentialCoefsCyl(const BasePotential &pot, 
    const unsigned int mmax,
    const std::vector<double> &gridR,
    const std::vector<double> &gridz,
    std::vector< math::Matrix<double> > &Phi,
...
*/
EXP void computePotentialCoefsCyl(const BaseDensity& dens, 
    const unsigned int mmax,
    const std::vector<double> &gridR,
    const std::vector<double> &gridz,
    std::vector< math::Matrix<double> > &Phi,
...
*/
EXP void computePotentialCoefsCyl(
    const particles::ParticleArray<coord::PosCyl>& particles,
