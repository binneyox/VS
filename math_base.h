...
/// convenience function for raising a number to the 4th power
template<typename T> inline T pow_4(T x) { return pow_2(x)*pow_2(x); }
...
*/
class EXP IFunctionNoDeriv: public IFunction {
public:
...
class EXP IFunctionNdimAdd: public IFunctionNdim {
public:
...
class EXP IFunctionNdimDeriv: public IFunctionNdim {
public:
    IFunctionNdimDeriv() {};
