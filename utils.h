...
*/
extern EXP VerbosityLevel verbosityLevel;


EXP VerbosityLevel getVerbosityLevel(void);
...
EXP std::string toString(double val, unsigned int width=6);
EXP std::string toString(float val, unsigned int width=6);
...
EXP std::string pp(double num, unsigned int width);
...
//encode a real number in 5-character string
EXP std::string jjbcmp(double);
EXP bool jjbget(FILE*,float*,int);
}  // namespace
