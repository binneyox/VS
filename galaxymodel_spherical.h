...
*/
class EXP SphericalIsotropicModel {
public:
...
*/
class EXP SphericalIsotropicModelLocal: public SphericalIsotropicModel {
...
*/
EXP std::vector<double> computeDensity(
    const math::IFunction& df,
...
*/
EXP void computeProjectedDensity(
